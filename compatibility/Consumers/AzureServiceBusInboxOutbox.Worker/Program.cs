...
if (provider.GetRequiredService<IMessagePublisher>() is null || provider.GetRequiredService<IMessageReceiver>() is null) return 1;
Console.WriteLine("TCJ.Messaging.AzureServiceBus Inbox/Outbox consumer passed"); return 0;
