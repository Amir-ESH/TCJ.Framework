...
TCJ Framework validates every locally packed development package against the latest immutable package version published to NuGet.org. The current baseline is `0.1.0-preview.4`.
