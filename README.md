...
NuGet packages and symbol packages are written to `artifacts/packages`. Pack also validates binary compatibility against the latest published TCJ packages.
