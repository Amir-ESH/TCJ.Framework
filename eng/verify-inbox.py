...
def validate_config()->tuple[dict[str,Any],dict[str,Any]]:
    ...
    require(ROOT/'src/TCJ.EntityFrameworkCore/Outbox/Processing/OutboxProcessor.cs','OutboxMessageContext(message.Id, message.EventType, attempt, message.CorrelationId, message.CausationId)')
