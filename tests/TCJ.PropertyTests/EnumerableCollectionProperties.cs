...
public sealed class EnumerableCollectionProperties
{
    ...
    [Property(MaxTest = 100, Replay = "1202,2202", Arbitrary = new[] { typeof(PropertyArbitraries) })]
    [Trait("Category", "Property")]
    [Trait("Category", "Enumerable")]
    ...
    [Property(MaxTest = 100, Replay = "1203,2203", Arbitrary = new[] { typeof(PropertyArbitraries) })]
    [Trait("Category", "Property")]
    ...
    [Property(MaxTest = 100, Replay = "1204,2204", Arbitrary = new[] { typeof(PropertyArbitraries) })]
    [Trait("Category", "Property")]
    [Trait("Category", "Collection")]
    ...
    [Property(MaxTest = 100, Replay = "1205,2205", Arbitrary = new[] { typeof(PropertyArbitraries) })]
    [Trait("Category", "Property")]
    [Trait("Category", "Enumerable")]
