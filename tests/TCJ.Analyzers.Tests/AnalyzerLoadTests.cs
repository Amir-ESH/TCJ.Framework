...
public sealed class AnalyzerLoadTests
{
    ...
    public async Task Analyzer_assembly_loads_under_the_test_compiler_with_registered_rules()
    {
        ...
        DomainEventHandlerLifetimeMarkerAnalyzer handlerLifetimeAnalyzer =
            Assert.Single(analyzers.OfType<DomainEventHandlerLifetimeMarkerAnalyzer>());
        ...
        Assert.Equal("TCJ0004", Assert.Single(handlerLifetimeAnalyzer.SupportedDiagnostics).Id);
